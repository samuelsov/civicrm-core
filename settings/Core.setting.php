...
return array(
  ...
  'createRelOnSharedAddress' => array(
    'group_name' => 'CiviCRM Preferences',
    'group' => 'core',
    'name' => 'createRelOnSharedAddress',
    'type' => 'Boolean',
    'quick_form_type' => 'YesNo',
    'default' => 1,
    'add' => '5.4',
    'title' => 'Link employer relationship to the shared address between individual and organization',
    'is_domain' => 1,
    'is_contact' => 0,
    'description' => 'If enabled, create/update employer relationship when creating/editing a shared address between an individual and an organization.',
    'help_text' => NULL,
  ),
